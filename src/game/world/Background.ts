...
export class Background {
  ...
  constructor(scene: Phaser.Scene) {
    ...
    scene.add.image(1225, WORLD.grassTopY + 20, 'tree').setOrigin(0.5, 1).setDepth(DEPTH.midground).setFlipX(true);
    scene.add.image(1010, WORLD.grassTopY + 10, 'fence').setOrigin(0.5, 1).setDepth(DEPTH.midground);
